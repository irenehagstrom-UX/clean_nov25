...
const imageDatabase: Record<string, string[]> = {
  "AIVEN_25APRIL_stage.jpg": ["facilitator", "presenter", "aiven"],
  "images/8cl_werbung2.jpg": ["freelancer", "brand", "logo", "marketing", "graphic"],
  "images/AIVEN_25APRIL_stage.jpg": ["facilitator", "presenter", "aiven"],
  "images/PD-Keks-portal.png": ["cornelsen", "edtech", "ui", "e-learning", "web"],
  "images/PD-Keks-results.png": ["cornelsen", "edtech", "e-learning", "ui", "ux"],
  ...
  "images/PD-keks-func_specs_b.png": ["e-learning", "requirements", "functional spec", "cornelsen"],
  "images/PD-learncoachies-flow.png": ["cornelsen", "e-learning", "workflow", "process"],
  "images/PD-learncoachies-screen.png": ["cornelsen", "edtech", "ui", "e-learning"],
  "images/PD-learncoachies_book.png": ["cornelsen", "edtech", "ui", "e-learning"],
  "images/PD-stadnard-req.png": ["requirements", "functional spec", "standards australia"],
  "images/PD-stadnards-flow.png": ["business analyst", "workflow", "process", "standards australia"],
  "images/PD-stadnards-hub2.png": ["standards australia", "ui"],
  "images/PD-stadnardhub.png": ["wireframes", "testing", "prototype", "standards australia"],
  ...
  "images/PD_arts_tumb.jpg": ["art", "drawing"],
  "images/PD_brand_brochure.png": ["print"],
  "images/PD_brand_logos.png": ["freelancer", "brand", "marketing", "graphic", "print"],
  "images/PD_branding_thumb.png": ["brand", "marketing"],
  ...
  "images/PD_fashion_e-com.png": ["honeyants", "fashion", "e-commerce", "marketing", "sales"],
  "images/PD_fashion_fabric.jpg": ["honeyants", "fashion", "clothes", "graphic"],
  "images/PD_fashion_pants.jpg": ["honeyants", "fashion", "marketing", "sales"],
  "images/PD_fashion_photos.png": ["honeyants", "fashion", "marketing", "sales"],
  "images/PD_fasion_rack.jpg": ["honeyants", "fashion", "clothes"],
  "images/PD_frames.jpg": ["art", "photo"],
  "images/PD_honeyants_e-com.png": ["honeyants", "fashion", "marketing", "sales", "e-commerce"],
  "images/PD_honeyants_thumb.jpg": ["honeyants", "fashion", "clothes", "graphic", "print"],
  "images/PD_industrial design.jpg": ["industrial", "thesis", "product design"],
  "images/PD_industrial design.png": ["industrial", "thesis", "product design"],
  "images/PD_industrial.png": ["industrial", "thesis", "product design"],
  "images/PD_industrial_2.jpg": ["industrial", "thesis", "product design"],
  "images/PD_industrial_A.png": ["industrial", "thesis", "product design"],
  "images/PD_industrial_B.png": ["industrial", "thesis", "product design"],
  "images/PD_industrial_C.png": ["industrial", "thesis", "product design"],
  "images/PD_industrial_D.png": ["industrial", "thesis", "product design"],
  "images/PD_industrial_reeko.jpg": ["industrial", "thesis", "product design"],
  "images/PD_kapa.png": ["ai"],
  "images/PD_keks_thumb.png": ["cornelsen", "edtech", "e-learning"],
  "images/PD_learncoachies_func_specs.png": ["cornelsen", "edtech", "functional specs", "requirements", "e-learning"],
  "images/PD_presenter.jpg": ["presenter", "facilitator"],
  "images/PD_presenter_2.jpg": ["presenter", "facilitator"],
  "images/PD_project management.jpg": ["project manager", "project management"],
  "images/PD_standards_hub-project.jpg": ["standards australia", "ui"],
  "images/PD_ux_journey_2.png": ["ui", "tech", "ux", "aiven", "service design", "journey"],
  "images/PD_worfklow.png": ["workflow", "business process analyst", "service design", "standards australia"],
  "images/PR-Cornelsen_Func specs.png": ["e-learning", "cornelsen", "persona"],
  "images/PR-PM_workshop.jpg": ["project manager", "project management", "facilitator", "workshop", "aiven"],
  "images/PR-aivenCRDR.png": ["aiven", "ux", "ui", "user interface", "technical design"],
  "images/PR-aiven_workshop.jpg": ["facilitator", "project manager", "product manager", "aiven"],
  "images/PR-honeyants-magazine.png": ["honeyants", "fashion", "clothes", "marketing"],
  "images/PR-pm-iso.png": ["project manager", "project management", "workshop", "standards australia"],
  "images/PR-stadnard-leading.png": ["testing", "prototype", "standards australia"],
  "images/PR-stadnards_functional spec.png": ["standards australia", "functional spec", "requirements"],
  "images/PR-standards.png": ["prototype", "testing", "standards australia"],
  "images/PR-standards_process.png": ["business analyst", "workflow", "process", "standards australia"],
  "images/PR_aiven_CRDR.png": ["aiven", "ux", "ui", "user interface", "technical design"],
  "images/PR_aiven_app2.png": ["aiven", "ui", "ux", "tech"],
  "images/PR_aiven_cloud.png": ["aiven", "ui", "tech"],
  "images/PR_aiven_live.png": ["aiven", "ui", "user interface", "ux", "tech"],
  "images/PR_aiven_overview.png": ["aiven", "ui", "user interface", "ux", "tech"],
  "images/PR_aiven_scren.png": ["aiven", "ui", "ux"],
  "images/PR_aiven_thumb.png": ["aiven"],
  ...
  "images/PR_fashion_store.png": ["honeyants", "fashion", "clothes", "marketing"],
  "images/PR_fashion_thumb.png": ["honeyants", "fashion", "clothes", "marketing"],
  "images/PR_figma_prot.png": ["prototype", "ux"],
  "images/PR_honeyants_screenprinting.jpeg": ["honeyants", "fashion", "print design"],
  "images/PR_iso_meeting.jpg": ["project manager", "workshop", "standards australia"],
  "images/PR_keks_uml_diagram.png": ["service design", "e-learning", "workflow", "cornelsen"],
  "images/PR_pm_plan.png": ["project manager", "project management", "standards australia"],
  "images/PR_pm_thumb.png": ["project manager", "project management"],
  "images/PR_presenter_testing.png": ["presenter", "facilitator"],
  "images/PR_ux_services.png": ["ux"],
  "images/background_b.jpg": ["background"],
  "images/branding_thumb.png": ["brand", "marketing"],
  "images/lkzwo karten.jpg": ["lkzwo", "brand", "marketing", "graphic"],
  "dooyoo.png": ["dooyoo", "first job", "freelancer", "web"],
  "logos.png": ["freelancer", "brand", "logo", "marketing", "graphic"],
  // Personal photos
  "images/photos/irene_2.jpg": ["photography", "irene", "personal"],
  "images/photos/photo_irene_ski.jpg": ["photography", "irene", "skiing", "personal"],
  "images/photos/photo_irene_skiing.jpg": ["photography", "skiing", "personal"],
  "images/photos/photo_photography_lake.JPG": ["photography", "travel", "nature", "lake"],
  "images/photos/photo_photography_munk.jpg": ["photography", "travel", "nature"],
  "images/photos/photo_photography_munks.jpg": ["photography", "travel", "nature"],
  ...
  "images/photos/photo_photogrphy_sunset.JPG": ["photography", "sunset", "nature"],
  ...
  "images/photos/photo_travel_photography_lake.jpg": ["photography", "travel", "lake", "nature"],
  "images/photos/photo_travel_photogrphy.jpg": ["photography", "travel"],
  "images/photos/photo_travel_photogrphy_ankorwat.jpg": ["photography", "travel", "angkor wat", "cambodia"],
  // Web history images
  "images/webhistory/Web_2000_tecnet.png": ["freelancer", "web", "marketing"],
  "images/webhistory/web-2000-dooyoo.png": ["dooyoo", "freelancer", "web"],
  "images/webhistory/web-2001-angostec.png": ["freelancer", "web", "marketing"],
  "images/webhistory/web-2004-gekolia.png": ["freelancer", "web", "marketing"],
  "images/webhistory/web-2015-lkzwo.gif": ["lkzwo", "web", "marketing", "brand"],
  "images/webhistory/web-2017-legalito.gif": ["lkzwo", "web", "marketing", "brand"],
  "images/webhistory/web-2022-Lead.gif": ["freelancer", "web", "marketing"],
  "images/webhistory/web_2000_8cl.png": ["freelancer", "web", "marketing"],
  "images/webhistory/web_2001_aphacontect.png": ["freelancer", "web"],
  "images/webhistory/web_2002_triple0.png": ["freelancer", "web"],
  "images/webhistory/web_2006_8cl.png": ["freelancer", "web", "marketing"],
  "images/webhistory/web_2008_s&F.png": ["freelancer", "web"],
};
